...
class DeBsrSpider(scrapy.Spider):
    name = 'de_bsr'
    allowed_domains = ['amazon.de',"www.amazon.de"]
    main_domain = "https://www.amazon.de"
    start_urls = ['https://www.amazon.de/gp/bestsellers/?ref_=nav_cs_bestsellers']
    finished_cate = []

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.level = int(getattr(self, "level", 4))
        self.appoint = "Küche, Haushalt & Wohnen"
